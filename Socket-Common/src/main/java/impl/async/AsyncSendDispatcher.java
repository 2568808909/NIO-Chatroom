...
public class AsyncSendDispatcher implements SendDispatcher, IoArgs.IoArgsEventProcessor , AsynPacketReader.PacketProvider {
    ...
    private final AsynPacketReader reader=new AsynPacketReader(this);
